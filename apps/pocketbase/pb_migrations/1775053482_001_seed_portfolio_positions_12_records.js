...
migrate((app) => {
  ...
  const record0 = new Record(collection);
    ...
    record0.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record0);
  } catch (e) {
  ...
  const record1 = new Record(collection);
    ...
    record1.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record1);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record3 = new Record(collection);
    ...
    record3.set("currentPriceManual", 195);
    record3.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record3);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record4 = new Record(collection);
    ...
    record4.set("currentPriceManual", 105);
    record4.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record4);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record5 = new Record(collection);
    const record5_userIdLookup = app.findFirstRecordByFilter("users", "email='admin@mercator.local'");
    if (!record5_userIdLookup) { throw new Error("Lookup failed for userId: no record in 'users' matching \"email='admin@mercator.local'\""); }
    ...
    record5.set("buyDate", "2024-06-18");
  ...
  const record6 = new Record(collection);
    const record6_userIdLookup = app.findFirstRecordByFilter("users", "email='admin@mercator.local'");
    if (!record6_userIdLookup) { throw new Error("Lookup failed for userId: no record in 'users' matching \"email='admin@mercator.local'\""); }
    ...
    record6.set("buyDate", "2024-07-22");
    record6.set("isCore", false);
    record6.set("isSatellite", true);
    record6.set("currentPriceManual", 820);
    record6.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record6);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record7 = new Record(collection);
    const record7_userIdLookup = app.findFirstRecordByFilter("users", "email='admin@mercator.local'");
    if (!record7_userIdLookup) { throw new Error("Lookup failed for userId: no record in 'users' matching \"email='admin@mercator.local'\""); }
    record7.set("userId", record7_userIdLookup.id);
    record7.set("ticker", "ISHARES_MSCI");
    ...
    record7.set("buyDate", "2024-08-30");
    record7.set("isCore", true);
    record7.set("isSatellite", false);
    record7.set("currentPriceManual", 92);
    record7.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record7);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record8 = new Record(collection);
    const record8_userIdLookup = app.findFirstRecordByFilter("users", "email='admin@mercator.local'");
    if (!record8_userIdLookup) { throw new Error("Lookup failed for userId: no record in 'users' matching \"email='admin@mercator.local'\""); }
    ...
    record8.set("buyDate", "2024-09-14");
    record8.set("isCore", true);
    record8.set("isSatellite", false);
    record8.set("currentPriceManual", 295);
    record8.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record8);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record9 = new Record(collection);
    const record9_userIdLookup = app.findFirstRecordByFilter("users", "email='admin@mercator.local'");
    if (!record9_userIdLookup) { throw new Error("Lookup failed for userId: no record in 'users' matching \"email='admin@mercator.local'\""); }
    ...
    record9.set("buyDate", "2024-10-05");
  ...
  const record10 = new Record(collection);
    const record10_userIdLookup = app.findFirstRecordByFilter("users", "email='admin@mercator.local'");
    if (!record10_userIdLookup) { throw new Error("Lookup failed for userId: no record in 'users' matching \"email='admin@mercator.local'\""); }
    ...
    record10.set("buyDate", "2024-11-11");
    record10.set("isCore", false);
    record10.set("isSatellite", true);
    record10.set("currentPriceManual", 48);
    record10.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record10);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record11 = new Record(collection);
    const record11_userIdLookup = app.findFirstRecordByFilter("users", "email='admin@mercator.local'");
    if (!record11_userIdLookup) { throw new Error("Lookup failed for userId: no record in 'users' matching \"email='admin@mercator.local'\""); }
    ...
    record11.set("buyDate", "2024-12-01");
    record11.set("isCore", true);
    record11.set("isSatellite", false);
    record11.set("currentPriceManual", 650);
    record11.set("currentPriceUpdatedAt", "2026-04-01");
  try {
    app.save(record11);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
