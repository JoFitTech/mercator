...
migrate((app) => {
  ...
  const record0 = new Record(collection);
    ...
    record0.set("ticker", "MSFT");
    record0.set("name", "Microsoft");
  ...
  const record1 = new Record(collection);
    ...
    record1.set("ticker", "VWRL");
    record1.set("name", "Vanguard FTSE All-World");
    record1.set("assetType", "ETF");
    record1.set("region", "Europa");
    record1.set("country", "Irland");
    record1.set("sector", "Diversifiziert");
    record1.set("currency", "EUR");
    record1.set("shares", 100);
    record1.set("buyPrice", 95);
  ...
  const record4 = new Record(collection);
    ...
    record4.set("ticker", "PENNYSTOCK1");
    record4.set("name", "Emerging Tech Penny");
    record4.set("assetType", "Aktie");
    record4.set("region", "Asien");
    record4.set("country", "Singapur");
    record4.set("sector", "Technologie");
    record4.set("currency", "SGD");
    record4.set("shares", 5000);
    record4.set("buyPrice", 0.15);
  ...
  const record5 = new Record(collection);
    ...
    record5.set("ticker", "ISHARES_MSCI");
    record5.set("name", "iShares MSCI World");
    record5.set("assetType", "ETF");
    record5.set("region", "Global");
    record5.set("country", "Irland");
    record5.set("sector", "Diversifiziert");
    record5.set("currency", "EUR");
    record5.set("shares", 50);
    record5.set("buyPrice", 72);
  ...
  const record6 = new Record(collection);
    ...
    record6.set("shares", 40);
    record6.set("buyPrice", 185);
  ...
  const record8 = new Record(collection);
    ...
    record8.set("name", "Roche Holding");
  ...
  const record9 = new Record(collection);
    ...
    record9.set("ticker", "NOVO_NORDISK");
    record9.set("name", "Novo Nordisk");
    record9.set("assetType", "Aktie");
    record9.set("region", "Europa");
    record9.set("country", "D\u00e4nemark");
    record9.set("sector", "Pharma");
    record9.set("currency", "DKK");
    record9.set("shares", 35);
    record9.set("buyPrice", 650);
    record9.set("isCore", true);
  try {
    app.save(record9);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record10 = new Record(collection);
    ...
    record10.set("ticker", "BERKSHIRE");
    record10.set("name", "Berkshire Hathaway");
    record10.set("assetType", "Aktie");
    record10.set("region", "Nordamerika");
    record10.set("country", "USA");
    record10.set("sector", "Finanzen");
    record10.set("currency", "USD");
    record10.set("shares", 5);
    record10.set("buyPrice", 620000);
  ...
  const record11 = new Record(collection);
    ...
    record11.set("ticker", "EMERGING_BOND");
    record11.set("name", "Emerging Markets Bond Fund");
    record11.set("assetType", "Anleihe");
    record11.set("region", "Schwellenl\u00e4nder");
    record11.set("country", "Brasilien");
    record11.set("sector", "Finanzen");
    record11.set("currency", "BRL");
    record11.set("shares", 1000);
    record11.set("buyPrice", 98);
    record11.set("isSatellite", true);
  try {
    app.save(record11);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
