...
BALANCE_SHEET_STATEMENT_ENDPOINT = "/balance-sheet-statement"
KEY_METRICS_ENDPOINT = "/key-metrics"
...
DEFAULT_GATE_MIN_TRADE_VALUE = 100_000
...
class AppSettings:
    ...
    trade_republic_universe_local_csv: str
