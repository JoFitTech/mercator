...
\begin{itemize}
  \item \textbf{Oeffentliche API als Datenquelle:} FMP API wird genutzt und dokumentiert. % Repo-Evidenz prüfen
  \item \textbf{Pandas-Verarbeitung:} Normalisierung, Gates und Akkumulation sind umgesetzt. % Repo-Evidenz prüfen
  \item \textbf{MySQL als Datenbank:} Clean Store mit strukturierten Tabellen ist umgesetzt. % Repo-Evidenz prüfen
  \item \textbf{MongoDB als Datenbank:} Raw Store fuer flexible Daten ist umgesetzt. % Repo-Evidenz prüfen
  \item \textbf{Interaktive Streamlit-UI:} Dashboard, Explorer und Methodik-Seite sind vorhanden. % Repo-Evidenz prüfen
  \item \textbf{Mindestens eine Visualisierung:} Buy/Sell-Charts, Trends und KPIs sind vorhanden. % Repo-Evidenz prüfen
  \item \textbf{Beide Datenbanken gelesen:} MySQL fuer Analyse, MongoDB fuer Raw-Counts im Admin-Bereich. % Repo-Evidenz prüfen
  \item \textbf{Akademische Nachvollziehbarkeit:} Methodik-Seite und Dokumentation sind vorhanden. % Repo-Evidenz prüfen
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Skalierbarkeit:} Single-Instance Streamlit, keine horizontale Skalierung ohne Docker/Cloud. % Eigene methodische Ableitung
    \begin{itemize}
      ...
      \item Fuer produktive Nutzung: mehrere Worker, Message Queue und Caching erforderlich.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
  \item \textbf{Signaltrennung nicht validiert:} % Eigene methodische Ableitung
    \begin{itemize}
      ...
      \item Keine statistischen Signifikanztests.
...
\begin{itemize}
  ...
  \item \textbf{500-Tage-Lookback (API3):} % Interne Projektspezifikation
    \begin{itemize}
      ...
      \item Groessere Fenster liefern stabilere Trendschaetzungen, erfordern aber mehr API-Aufrufe.
    \end{itemize}
...
\begin{itemize}
  \item \textbf{Robustere Retry- und Fehlerbehandlung:}
    \begin{itemize}
      ...
      \item Detailliertes Error-Logging und Monitoring.
    \end{itemize}
  ...
  \item \textbf{Mobile Responsiveness:}
    \begin{itemize}
      \item Die aktuelle Streamlit-Version bietet grundlegende mobile Unterstuetzung; weitere Optimierungen sind moeglich. % TODO: pruefen
    \end{itemize}
\end{itemize}
