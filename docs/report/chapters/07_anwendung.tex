...
\begin{itemize}
  \item \textbf{📊 Dashboard:} % Repo-Evidenz prüfen
    ...
    \end{itemize}
  \item \textbf{🕵️ Trade-Explorer (Hauptarbeitsfläche):} % Repo-Evidenz prüfen
    \begin{itemize}
  ...
  \item \textbf{📖 Methodik:} % Repo-Evidenz prüfen
    ...
    \end{itemize}
  \item \textbf{⚙️ Einstellungen:} % Repo-Evidenz prüfen
    \begin{itemize}
    ...
    \end{itemize}
  \item \textbf{🛠️ Admin:} % Repo-Evidenz prüfen
    \begin{itemize}
...
\begin{itemize}
  \item \textbf{Filterung:}
    \begin{itemize}
      ...
      \item Filter-Panel collapsible zur UI-Platzoptimierung. % Repo-Evidenz prüfen
    \end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Kontrast und Lesbarkeit:}
    \begin{itemize}
      \item Schriftgrößen und Farbpaletten folgen Standard-Accessibility-Richtlinien.
  ...
  \item \textbf{Navigation und Struktur:}
    \begin{itemize}
      ...
      \item Tastatur-Navigation unterstützt.
    \end{itemize}
\end{itemize}
...
\begin{itemize}
  ...
  \item \textbf{Effekt:}
    \begin{itemize}
      ...
      \item Fehler und Warnung-Details angezeigt.
    \end{itemize}
\end{itemize}
