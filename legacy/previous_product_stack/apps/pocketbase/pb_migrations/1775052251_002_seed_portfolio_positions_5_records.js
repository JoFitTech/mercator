...
migrate((app) => {
  ...
  const record2 = new Record(collection);
    ...
    record2.set("ticker", "VANGUARD");
    record2.set("name", "Vanguard S&P 500 ETF");
    record2.set("assetType", "ETF");
    record2.set("shares", 100);
    record2.set("buyPrice", 420.75);
  ...
  const record3 = new Record(collection);
    ...
    record3.set("ticker", "TESLA");
    record3.set("name", "Tesla Inc.");
    record3.set("assetType", "Aktie");
    record3.set("shares", 20);
    record3.set("buyPrice", 245.3);
    record3.set("buyDate", "2024-01-05");
  try {
    app.save(record3);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
  ...
  const record4 = new Record(collection);
    ...
    record4.set("ticker", "NVIDIA");
    record4.set("name", "NVIDIA Corp.");
    record4.set("assetType", "Aktie");
    record4.set("shares", 15);
    record4.set("buyPrice", 875.2);
    record4.set("buyDate", "2024-03-01");
  try {
    app.save(record4);
  } catch (e) {
    if (e.message.includes("Value must be unique")) {
